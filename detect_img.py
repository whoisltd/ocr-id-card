...
image = cv2.imread('/home/whoisltd/Desktop/cccdchip/34.jpg')
# detector = Detector('/home/whoisltd/detect/training/exported-models/my_model/pipeline.config', '/home/whoisltd/detect/training/exported-models/my_model/checkpoint/ckpt-0', '/home/whoisltd/detect/tf_record_text/label_map.pbtxt')
# detector = Detector('/home/whoisltd/detect/training/exported-models/detext_corner_model/pipeline.config',
#                     '/home/whoisltd/detect/training/exported-models/detext_corner_model/checkpoint/ckpt-0', '/home/whoisltd/detect/data/tf_record_corner/label_map.pbtxt')
detector = Detector('/home/whoisltd/detect/training/exported-models/ctc_chip/corner/pipeline.config',
                    '/home/whoisltd/detect/training/exported-models/ctc_chip/corner/checkpoint/ckpt-0', '/home/whoisltd/detect/data/ctc_chip/corner/label_map.pbtxt')
# detector = Detector('/home/whoisltd/detect/training/exported-models/exported-corner-id-card/pipeline.config',
#                     '/home/whoisltd/detect/training/exported-models/exported-corner-id-card/checkpoint/ckpt-0', '/home/whoisltd/detect/data/id_card/corner/label_map.pbtxt')
start = time.time()
...
# print(coord)
# image = align_image(image, coordinate_dict)


end = time.time()
print("Estimated time: ", end - start)
cv2.imwrite('corner_test1.png', image)
